...
public class Normal {
	 ...
	 * @return
	 */
	public static final double random(double mu, double sigma, Random random)
	{
		return mu + sigma * random_standard(random);
	}

	public static final double random_standard(Random random)
	{
	...
	public static final double random_ahrens_dieter(double mu, double sigma, Random random)
	{
	    final double a[] = new double[]
	        {
	...
	public static final double random_kinderman_ramage(double mu, double sigma, Random random)
	{
		double u1, u2, u3, tt;
