...
public class Poisson {
	...
	public static final double random(double mu, Random random)
	{	return random(mu, random, null); }

	public static final double[] random(int n, double mu, Random random)
	{
	...
	public static final double random(double mu, Random random, RandomState state)
	{
		final double
		a0 = -0.5,
		a1 = 0.3333333,
